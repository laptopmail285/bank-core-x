...
const NAV_ITEMS = [
    ...
    { to: '/counter', label: 'Counter Operations' },
];
        ...
        <div className="flex min-h-screen">
            <aside className="w-64 shrink-0 bg-ink-900 text-white flex flex-col">
                <div className="px-6 py-6 border-b border-ink-700">
                    ...
                    <div className="text-xs text-white/50 mt-1">Staff Portal</div>
                </div>
                ...
                <div className="px-6 py-4 border-t border-ink-700 text-sm">
                    ...
                    <button onClick={signOut} className="mt-2 text-white/70 hover:text-white underline underline-offset-2">
                        Sign out
                    </button>
                </div>
            </aside>
